classdef ekf_slam_simu < handle
    %EKF_SLAM The EKF algorithm for SLAM
    % num_landmark (numbers of landmark robot see)
    % n  (state length)
    ...
    properties  
        ...
        sigxy = 0.0002; % The covariance of linear velocity
        sigth = 0.0001; % The covariance of angular velocity
        siglm = 0.1; % The covariance of landmark measurements
        
        idx2num = []; % The map from state vector index to l andmark id.
